...
import type { CCv2Data, CCv3Data, Card } from '@card-architect/schemas';
import {
  type BinaryData,
  readUInt32BE,
  writeUInt32BE,
 ...
 */
export function createCardPNG(
  baseImage: BinaryData,
  card: Card,
  options?: EmbedOptions
): BinaryData {
  return embedIntoPNG(baseImage, card.data, options);
}
